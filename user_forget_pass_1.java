...
public class user_forget_pass_1 extends HttpServlet
{
       ...
       // pw1.println("<html><body bgcolor=skyblue>Welcome "+nm1+"<br> Enter your password: "+nm2+"<br> Address: "+nm3+"<br> Email: "+nm4+"<br> Security Question: "+nm5+"<br> Ans"+nm6+"<br> Hobbies: "+nm7+"</body></html>");//response from servlet
        try
        {
           ...
           Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE","system","Nayan");
             ...
             String q1="Select * from customer where id='"+nm1+"'";
             ResultSet rs=stmt.executeQuery(q1);
            //pw1.println("<FORM METHOD =POST ACTION = f2>"+"<INPUT TYPE = SUBMIT></FORM>");
             if(rs.next())
             {
                 pw1.println("<html>\n" +
...
"    <form method=\"post\" action=\"user_foget_pass_2\" class=\"forget\">\n" +
"        <table>\n" +
"        <tr>\n" +
"           <td>Security Question: "+rs.getString(5)+" </td>\n" +
"       </tr>\n" +
"\n" +
"        <tr>\n" +
"            <td>Ans:</td>\n" +
...
"    <form method=\"post\" action=\"user_forget_pass_1\" class=\"forget\">\n" +
"        <table>\n" +
"        <tr>\n" +
"        <td>Email id:</td>\n" +
...
"        </tr>\n" +
"        <tr>\n"+
"        <font face=\"Arial\" size=\"6\" color=\"red\">Fetch Unsuccess</font>\n" +
"        </tr>\n"+
"        </table>\n" +
"    </form>\n" +
"<footer class = \"footer\">\n" +
