...
public class Admin_update_item extends HttpServlet
{
    public void doPost(HttpServletRequest req, HttpServletResponse res)throws IOException,ServletException
    {
        ...
        try
        {
           ...
           Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE","system","Nayan");
             ...
             String q1="update product set prod_price='"+nm2+"' where prod_id='"+nm1+"'";
...
"        </tr>\n" +
"        <tr>\n"+
"        <font face=\"Arial\" size=\"6\" color=\"red\">Updated Successfully</font>\n" +
"        </tr>\n"+
"        </table>\n" +
"        </form>\n" +
"    <footer class = \"footer\">\n" +
...
"        </div>\n" +
"    </header>\n" +
"<form method=\"post\" action=\"Admin_update_item\" class=\"update\">\n" +
...
"<tr>\n" +
"<td>Product price:</td>\n" +
"<td><input type=\"text\" name=\"n2\" placeholder=\"Type new product price\"></td>\n" +
"</tr>\n" +
"<tr><td><input type=\"submit\" value=\"sign in\"></td>\n" +
"</tr>\n" +
"<tr>\n"+
"<font face=\"Arial\" size=\"6\" color=\"red\">Update Failure</font>\n" +
"</tr>\n"+
"</table>\n" +
"</form>\n" +
"    <footer class = \"footer\">\n" +
