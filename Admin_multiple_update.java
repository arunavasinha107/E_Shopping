...
public class Admin_multiple_update extends HttpServlet
{
    public void doPost(HttpServletRequest req, HttpServletResponse res)throws IOException,ServletException
    {
        ...
        try
        {
           ...
           Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE","system","Nayan");
             ...
             String q1="update product set prod_name='"+nm2+"',prod_price='"+nm2+"' where prod_id='"+nm1+"'";
...
"        </tr>\n" +
"        <tr>\n"+
"        <font face=\"Arial\" size=\"6\" color=\"red\">Successfully Multiple Updated</font>\n" +
"        </tr>\n"+
"        </table>\n" +
"        </form>\n" +
"    <footer class = \"footer\">\n" +
...
"</html>");
             ...
             {
                 pw1.println("<html>\n" +
"<head><title>Multiple Update</title>\n" +
"<link rel=\"stylesheet\" href=\"https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.1.2/css/all.min.css\" integrity=\"sha512-1sCRPdkRXhBV2PBLUdRb4tMg1w2YPf37qatUFeS7zlBy7jJI8Lf4VHwWfZZfpXtYSLy85pkm9GaYVYMfw5BC1A==\" crossorigin=\"anonymous\" referrerpolicy=\"no-referrer\" />\n" +
"<style>\n" +
"        /* Header styling */\n" +
"        \n" +
...
"        </div>\n" +
"    </header>\n" +
"<form method=\"post\" action=\"Admin_multiple_update\" class=\"update\">\n" +
"<table border =\"0\" width=\"50%\">\n" +
"<tr>\n" +
"<td>Product id:</td>\n" +
"<td><input type=\"text\" name=\"n1\"\n" +
"placeholder=\"Type your product id whose price to be updated\"></td>\n" +
"</tr>\n" +
"<tr>\n" +
"<td>Product name:</td>\n" +
"<td><input type=\"text\" name=\"n2\" placeholder=\"Type new product name\"></td>\n" +
"</tr>\n" +
"<tr>\n" +
"<td>Product price:</td>\n" +
"<td><input type=\"text\" name=\"n3\" placeholder=\"Type new product price\"></td>\n" +
"</tr>\n" +
"<tr><td><input type=\"submit\" value=\"sign in\"></td>\n" +
"</tr>\n" +
"<tr>\n"+
"<font face=\"Arial\" size=\"6\" color=\"red\">Multiple Update Failure</font>\n" +
"</tr>\n"+
"</table>\n" +
"</form>\n" +
"    <footer class = \"footer\">\n" +
