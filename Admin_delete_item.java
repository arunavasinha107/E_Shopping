...
public class Admin_delete_item extends HttpServlet
{
    @Override
    public void doPost(HttpServletRequest req, HttpServletResponse res)throws IOException,ServletException
    {
        ...
        try
        {
           ...
           String q1="delete from product where prod_id='"+nm1+"'";
...
"        </tr>\n" +
"        <tr>\n"+
"        <font face=\"Arial\" size=\"6\" color=\"red\">Deleted Successfully</font>\n" +
"        </tr>\n"+
"        </table>\n" +
"        </form>\n" +
"    <footer class = \"footer\">\n" +
...
"        </div>\n" +
"    </header>\n" +
"<form method=\"post\" action=\"Admin_delete_item\" class=\"delete\">\n" +
"<table border =\"0\" width=\"50%\">\n" +
"<tr>\n" +
"<td>Product Id:</td>\n" +
"<td><input type=\"text\" name=\"n1\" placeholder=\"Enter product id you want to delete\"></td>\n" +
"</tr>\n" +
"<tr><td><input type=\"submit\" value=\"sign in\"></td>\n" +
"</tr>\n" +
"<tr>\n"+
"<font face=\"Arial\" size=\"6\" color=\"red\">Delete Failure</font>\n" +
"</tr>\n"+
"</table>\n" +
"</form>\n" +
"     <footer class = \"footer\">\n" +
